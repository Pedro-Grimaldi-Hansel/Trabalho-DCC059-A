...
class Graph{
    ...
    public:
        ...
        Solution coberturaMinimaGulosaRandomizada(float alpha, int nInteracoes, int seed);
        Solution coberturaMinimaGulosaRandomizadaReativa(float* alpha, int tammanhoVetor, int nIterecoes, int bloco, int seed);
